    ...
    <>
      <div className="md:hidden fixed top-4 left-4 z-50">
        <button
          ...
          className="text-gray-300 text-2xl p-2 bg-black/70 rounded-md"
        >
      ...
      >
        ...
        <div>
          ...
          {openDashboard && (
            <ul className="mt-2 ml-6 space-y-2 text-sm">
              <li className="hover:bg-[#1a1a1a] px-3 py-2 rounded-md cursor-pointer">
                Ecommerce
              </li>
              <li className="hover:bg-[#1a1a1a] px-3 py-2 rounded-md cursor-pointer">
                Analytics
        ...
        <div className="ml-6 space-y-2">
          <div className="flex items-center gap-2 px-2 py-2 cursor-pointer hover:bg-[#1a1a1a] rounded-md">
